...
namespace FFF {
	...
	TileSheet::TileSheet(const char* path, const u32 numPositions, const i32* positions)
	: Texture(path), numPositions(numPositions), inputPositions(positions), calculatedPositions() {}
